...
module.exports = class InstructorsService {
  ...
  static async update(data, id, currentUser) {
    const transaction = await db.sequelize.transaction();
    try {
      let instructors = await InstructorsDBApi.findBy(
        {id},
        {transaction},
      );
      ...
      const updatedInstructors = await InstructorsDBApi.update(
        id,
        data,
        {
          currentUser,
