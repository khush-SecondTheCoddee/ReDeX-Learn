                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ item.instructors }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>Students</p>
                                <p className={'line-clamp-2'}>{ item.students }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>DiscussionBoards</p>
                                <p className={'line-clamp-2'}>{ item.discussion_boards }</p>
                            </div>
