...
import { update, fetch } from '../../stores/discussion_boards/discussion_boardsSlice'
...
const EditDiscussion_boards = () => {
  ...
  useEffect(() => {
      if (typeof discussion_boards === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (discussion_boards)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit discussion_boards'} main>
        {''}
